    ...
    <div style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);background:var(--bg-card);border:1px solid var(--border);border-radius:16px;padding:32px;width:520px;max-width:90vw;max-height:85vh;overflow-y:auto;box-shadow:0 24px 48px rgba(0,0,0,0.3);">
      <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:24px;">
        <div>
          ...
          <div style="font-size:12px;color:var(--text-muted);margin-top:4px;">Keys are stored locally in your browser. Never shared.</div>
        </div>
      ...
      <div style="margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:8px;margin-bottom:8px;">
          ...
          <span id="polygon-key-status" style="font-size:12px;margin-left:auto;"></span>
        </div>
        <div style="font-size:12px;color:var(--text-muted);margin-bottom:6px;">Powers all market data, scanners, and real-time quotes. Get a free key at <a href="https://polygon.io" target="_blank" style="color:var(--blue);">polygon.io</a></div>
      ...
      <div style="margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:8px;margin-bottom:8px;">
          ...
          <span id="alpha-key-status" style="font-size:12px;margin-left:auto;"></span>
        </div>
        <div style="font-size:12px;color:var(--text-muted);margin-bottom:6px;">Used for supplemental data. Free key at <a href="https://www.alphavantage.co/support/#api-key" target="_blank" style="color:var(--blue);">alphavantage.co</a></div>
      ...
      <div style="margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:8px;margin-bottom:8px;">
          ...
          <span style="font-size:12px;padding:2px 6px;border-radius:3px;background:var(--bg-secondary);color:var(--text-muted);font-weight:700;">OPTIONAL</span>
          <span id="anthropic-key-status" style="font-size:12px;margin-left:auto;"></span>
        </div>
        <div style="font-size:12px;color:var(--text-muted);margin-bottom:6px;">Powers AI Analysis & Trade Coaching. Get a key at <a href="https://console.anthropic.com/settings/keys" target="_blank" style="color:var(--blue);">console.anthropic.com</a></div>
      ...
      <div style="margin-top:16px;padding:12px;background:var(--bg-secondary);border-radius:8px;font-size:12px;color:var(--text-muted);line-height:1.6;">
